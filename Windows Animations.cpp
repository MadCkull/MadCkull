...
1.1.7
ReDrag
All but TextInputHost.exe, ShellExperienceHost.exe, StartMenuExperienceHost.exe, SearchHost.exe, dwm.exe
Smooth minimize, restore, close, switch animations for windows.
Details
Settings
Source Code
Changelog
